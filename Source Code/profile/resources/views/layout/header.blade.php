  ...
  <div class="row height-80">
    ...
    <div class="col-sm-6 col-xs-6 align-self-center">
      <div class="row justify-content-end">
        <a href="#" class="a col-sm-2 col-xs-2 btn btn-main black margin-left-20">Projects</a>
        <a href="#" class="a col-sm-2 col-xs-2 btn btn-main black margin-left-20">Home</a>
